...
<form name="form1" method="post" class="layui-form" action="Admins_LetTapsAddServlet" style="text-align: center">
    <script>
...
<div class="layui-form-item" style="margin-top:5%;">
    ...
    <div class="layui-input-inline">
      <input type="text" name="Lno" required  lay-verify="required" placeholder="请输入编号" autocomplete="off" class="layui-input">
    </div>
  </div>
    </div>
...
<div class="layui-form-item">
  ...
  <div class="layui-form-item">
            <div class="layui-inline">
    <label class="layui-form-label"  style="width: 120px; ">输入音像信息：</label>
    <div class="layui-input-inline">
      <input type="text" name="LTaps" required  lay-verify="required" placeholder="请输入音像信息" autocomplete="off" class="layui-input">
    </div>
  </div>
    </div>
  ...
  <div class="layui-form-item">
            <div class="layui-inline">
    <label class="layui-form-label"  style="width: 120px; ">输入音像类别：</label>
    <div class="layui-input-inline">
