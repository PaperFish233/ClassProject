...
<script src="//unpkg.com/layui@2.6.8/dist/layui.js"></script>
  ...
  <body>
<form name="form1" method="post" action="Users_MessagessAddServlet" style="text-align: center">
  <script>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input type="text" name="Mcontent" required  lay-verify="required" placeholder="请输入新留言板信息" autocomplete="off" class="layui-input">
    </div>
  </div>
    </div>
...
<div class="layui-form-item">
          <div class="layui-inline">
    <label class="layui-form-label" style="width: 120px; ">当前时间：</label>
    <div class="layui-input-inline">
      <input type="text" name="Mtime" required  lay-verify="required" value="!${time}" readonly autocomplete="off" class="layui-input">
    </div>
  </div>
    </div>
