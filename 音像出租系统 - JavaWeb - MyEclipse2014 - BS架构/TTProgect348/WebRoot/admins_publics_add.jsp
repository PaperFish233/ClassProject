...
<div class="layui-form-item"  style="margin-top:5%;">
    ...
    <div class="layui-input-inline">
      <input type="text" name="Pno" required  lay-verify="required" placeholder="请输入编号" autocomplete="off" class="layui-input">
    </div>
  </div>
    </div>
...
<div class="layui-form-item">
          <div class="layui-inline">
    <label class="layui-form-label" style="width: 120px; ">填写新公告：</label>
    <div class="layui-input-inline">
      <input type="text" name="Pcontent" required  lay-verify="required" placeholder="请输入新公告" autocomplete="off" class="layui-input">
    </div>
  </div>
    </div>
