...
<div class="layui-form-item" style="margin-top:5%;">
    ...
    <div class="layui-input-inline">
      <input type="text" name="Tno" required  lay-verify="required" placeholder="请输入原编号" autocomplete="off" class="layui-input" style="width: 215px; ">
    </div>
  </div>
    </div>
...
<div class="layui-form-item">
          <div class="layui-inline">
    <label class="layui-form-label" style="width: 120px; ">修改音像信息为：</label>
    <div class="layui-input-inline">
      <input type="text" name="Tname" required  lay-verify="required" placeholder="请输入修改音像信息" autocomplete="off" class="layui-input"  style="width: 215px; ">
    </div>
  </div>
    </div>
		...
		<div class="x-body layui-form">
              <div class="layui-inline">
        <label class="layui-form-label" style="width: 120px; ">修改音像类型为：</label>
           <div class="layui-input-inline">
      ...
      <%
		...
		<div class="x-body layui-form"  style="margin-top:1%;">
              <div class="layui-inline">
        <label class="layui-form-label" style="width: 120px; ">修改音像状态为：</label>
           <div class="layui-input-inline">
